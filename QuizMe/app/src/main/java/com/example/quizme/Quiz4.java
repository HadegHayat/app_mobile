...
public class Quiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference questionsRef = FirebaseDatabase.getInstance().getReferenceFromUrl("https://quiz-farebase-default-rtdb.firebaseio.com/quizapp/questions/question4");
        ...
        questionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Quiz4.this, "Erreur de récupération des données", Toast.LENGTH_SHORT).show();
            }
        });
