...
public class Quiz3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference questionsRef = FirebaseDatabase.getInstance().getReferenceFromUrl("https://quiz-farebase-default-rtdb.firebaseio.com/quizapp/questions/question33");
        ...
        questionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(Quiz3.this, "Erreur de récupération des données", Toast.LENGTH_SHORT).show();
            }
        });
